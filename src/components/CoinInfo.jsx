...
const CoinInfo = ({coin}) => {
  return (
    <>
       <div className="container flex flex-col mx-auto max-w-[700px] w-full overflow-auto">
      <div className="">
        <p className="flex items-center text-center justify-center my-3 mx-auto text-2xl font-semibold uppercase p-3 shadow-xl md:w-[700px] w-[500px]">{coin.name}</p>
        </div>
      <div className="flex mx-auto uppercase md:w-[700px] w-[500px]">
        <span className="bg-bgPurple w-fit my-2 p-1 rounded font-semibold text-sm">Rank #{coin.market_cap_rank}</span>
      </div>
      <div className="container flex mx-auto justify-between md:w-[700px] w-[500px] ">
        ...
        <div className="">
          <p className="font-semibold text-3xl">{coin.market_data ? <p>${coin.market_data.current_price.usd.toLocaleString()}</p> : null}</p>
        </div>
      </div>
        <div className="flex items-center text-center justify-evenly my-3 mx-auto text-sm font-semibold uppercase p-3 shadow-xl md:w-[700px] w-[500px]">
